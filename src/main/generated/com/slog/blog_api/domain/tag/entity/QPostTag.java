package com.slog.blog_api.domain.tag.entity;
...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = 502405356L;
    ...
    public final com.slog.blog_api.domain.post.entity.QPost post;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.slog.blog_api.domain.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
